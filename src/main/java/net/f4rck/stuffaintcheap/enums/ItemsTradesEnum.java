...
public class ItemsTradesEnum {
    public enum ItemsTier1 {
        BOOK(new ItemStack(Items.BOOK, 4), new ItemStack(Items.EMERALD, 1),  12,5),
    ...
    public enum ItemsTier3 {
        NAME_TAG(new ItemStack(Items.NAME_TAG, 1), new ItemStack(Items.EMERALD, 20),  12, 30),
        GLASS(new ItemStack(Items.GLASS, 4),  new ItemStack(Items.EMERALD, 1),  16, 10),
        CLOCK(new ItemStack(Items.CLOCK, 1),  new ItemStack(Items.EMERALD, 1),  12, 20),
        COMPASS(new ItemStack(Items.COMPASS, 1),  new ItemStack(Items.EMERALD, 1),  12, 20);
